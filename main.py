...
from compute_loss import task1_compute_metric
import pdb
...
model_task1 = AutoModelForImageTextToText.from_pretrained("./checkpoints/checkpoint-task1", **model_kwargs)
processor = AutoProcessor.from_pretrained("./checkpoints/checkpoint-task1")
...
trainer = SFTTrainer(
    ...
    compute_metrics=task1_compute_metric,
)
